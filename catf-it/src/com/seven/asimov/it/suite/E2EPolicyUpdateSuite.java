...
public class E2EPolicyUpdateSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(E2EPolicyUpdateSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.e2e.policyupdate");

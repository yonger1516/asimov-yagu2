...
public class MediaStateConditionSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(MediaStateConditionSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.generic.application.handler.mediastate");

...
public class AssignTrafficToAppSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(AssignTrafficToAppSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.communication.apptraffic");

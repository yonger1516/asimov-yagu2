...
public class TransparentSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(TransparentSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.dispatchers.transparent");

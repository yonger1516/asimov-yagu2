...
public class GenericApplicationHandlerSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(GenericApplicationHandlerSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.generic.application.handler");

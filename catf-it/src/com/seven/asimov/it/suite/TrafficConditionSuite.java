...
public class TrafficConditionSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(TrafficConditionSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.generic.application.handler.traffic");

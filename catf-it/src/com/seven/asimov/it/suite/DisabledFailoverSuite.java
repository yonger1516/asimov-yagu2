...
public class DisabledFailoverSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(DisabledFailoverSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.failover.disabled");

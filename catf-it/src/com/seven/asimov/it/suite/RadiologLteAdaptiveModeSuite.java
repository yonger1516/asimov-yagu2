...
public class RadiologLteAdaptiveModeSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(RadiologLteAdaptiveModeSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.crcs.radiolog.lte.adaptive");

...
public class MsisdnValidationSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(MsisdnValidationSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.communication.msisdn");

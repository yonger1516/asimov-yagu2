...
public class RadiologLteFixedModeSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(RadiologLteFixedModeSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.crcs.radiolog.lte.fixed");

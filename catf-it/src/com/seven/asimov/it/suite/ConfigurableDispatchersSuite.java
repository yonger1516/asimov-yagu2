...
public class ConfigurableDispatchersSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(DeviceSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.dispatchers.configurable");

...
public class RelayCommunicationSmsSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(RelayCommunicationSmsSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.communication.relay.sms");

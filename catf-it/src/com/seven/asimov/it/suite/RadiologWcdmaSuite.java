...
public class RadiologWcdmaSuite {
    public static Test suite() {
        TestSuiteBuilder builder = new TestSuiteBuilder(RadiologWcdmaSuite.class);
        builder.includePackages("com.seven.asimov.it.tests.crcs.radiolog.wcdma");

package com.seven.asimov.it.tests.communication.relay.sms;
 ...
 * <ul>
 * <li>client.msisdn_validation_protocol=sms</li>
 * <li>client.msisdn_validation_enabled=1</li>
 * </ul>
 */
public class RelayCommunicationSms extends TcpDumpTestCase {
    ...
    /**
     * <p>Received SMS with invalidate when radio UP and 7ztp connection to Relay is closed.</p>
     ...
     * <li>SMS with invalidate come to client  in interval 85 s. after 4th request was sent</li>
     * <li>OC should send get cached request to TH immediately after receiving of SMS</li>
     * <li>5th request should be HITed with new response from TH</li>
     * </ul>
     */
    @Execute
    @SmallTest
    public void testCommunicationViaSms_001() throws Exception {
        updateFor3gOnly();
        final int RI = 85 * 1000;
        executorService.submit(radioUpKeeperThread);
        String resource = "test_RelayCommunication_001_ViaSms";
    ...
    /**
     * <p>Received SMS with invalidate when radio DOWN and 7ztp connection to Relay is closed</p>
     * <p>A test resource is needed for this test case that returns the same responses for first 4 requests
     * and 3 other responses for next requests</p>
     * <p>Pattern [0,85,85,85,85,85,85]</p>
     * <p>Steps:</p>
     * <ul>
     * <li>Ensure that only 3G is active</li>
     * <li>Send 3 requests with some RI. RI-based polling should start.</li>
    ...
    @SmallTest
    public void testCommunicationViaSms_002() throws Exception {
        updateFor3gOnly();
        final int RI = 85 * 1000;
        String resource = "test_RelayCommunication_002_ViaSms";
        final String uri = createTestResourceUri(resource);
        ...
        try {
            ...
            logSleeping(RI - response.getDuration() - 30 * 1000);
            // 1.5
    ...
    /**
     * <p>Change radio state to UP after receive SMS invalidate in Long Poll</p>
    ...
    @SmallTest
    public void testCommunicationViaSms_003() throws Exception {
        updateFor3gOnly();
        final int RI = 100 * 1000;

        String resource = "test_RelayCommunication_003_ViaSms";
        final String uri = createTestResourceUri(resource);
        int requestId = 0;
        IWCTask iwcTask = new IWCTask();
        LogcatUtil logcatUtil = new LogcatUtil(getContext(), iwcTask);
    ...
    @SmallTest
    public void testCommunicationViaSms_004() throws Exception {
        updateFor3gOnly();
        final int RI = 85 * 1000;
        executorService.submit(radioUpKeeperThread);
        String resource = "test_RelayCommunication_001_ViaSms";
